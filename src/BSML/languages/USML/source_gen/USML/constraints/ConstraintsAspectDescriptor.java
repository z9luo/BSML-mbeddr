...
public class ConstraintsAspectDescriptor implements jetbrains.mps.smodel.runtime.ConstraintsAspectDescriptor {
  ...
  private static String[] stringSwitchCases_2qnle6_a0a0b = new String[]{"USML.structure.AbstractBlock", "USML.structure.CFunctionBinding", "USML.structure.CreateEventInstance", "USML.structure.EventArgReference", "USML.structure.EventCall", "USML.structure.IEvent", "USML.structure.IRegion", "USML.structure.IState", "USML.structure.ITransition", "USML.structure.OutEventDeclaration", "USML.structure.RegionLocalDeclaration", "USML.structure.SMGlobalDeclaration", "USML.structure.StateLocalDeclaration", "USML.structure.Transition", "USML.structure.TriggerEventReference"};
}
