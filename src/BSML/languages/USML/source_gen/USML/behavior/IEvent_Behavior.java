...
public class IEvent_Behavior {
  ...
  public static Iterable<SNode> callSuper_args_2486662774781081797(SNode thisNode, String callerConceptFqName) {
    return BehaviorManager.getInstance().invokeSuper((Class<Iterable<SNode>>) ((Class) Object.class), SNodeOperations.cast(thisNode, "USML.structure.IEvent"), callerConceptFqName, "virtual_args_2486662774781081797", new Class[]{SNode.class}, new Object[]{});
  }
}
