...
public class EntryBlock_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_a5eoag_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_a5eoag_c0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_a5eoag_c0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ";");
    editorCell.setCellId("Constant_a5eoag_c0");
    Style style = new StyleImpl();
