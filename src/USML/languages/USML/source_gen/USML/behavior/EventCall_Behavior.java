...
public class EventCall_Behavior {
  ...
  public static List<SNode> virtual_getFormals_8011039602902827397(SNode thisNode) {
    return ListSequence.fromList((new ArrayList<SNode>())).addSequence(Sequence.fromIterable(BehaviorReflection.invokeVirtual((Class<Iterable<SNode>>) ((Class) Object.class), SLinkOperations.getTarget(thisNode, "eventRef", false), "virtual_args_2486662774781081797", new Object[]{})));
  }

  public static SNode virtual_getNodeForTypeCalc_8729127847821610916(SNode thisNode) {
    return SLinkOperations.getTarget(thisNode, "eventRef", false);
  }
}
