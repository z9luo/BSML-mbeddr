...
public class IRegion_Behavior {
  ...
  public static SNode callSuper_initState_4306907833977380124(SNode thisNode, String callerConceptFqName) {
    return BehaviorManager.getInstance().invokeSuper((Class<SNode>) ((Class) Object.class), SNodeOperations.cast(thisNode, "USML.structure.IRegion"), callerConceptFqName, "virtual_initState_4306907833977380124", new Class[]{SNode.class}, new Object[]{});
  }
  ...
  public static Iterable<SNode> callSuper_getContainedOthers_4306907833977812919(SNode thisNode, String callerConceptFqName) {
    return BehaviorManager.getInstance().invokeSuper((Class<Iterable<SNode>>) ((Class) Object.class), SNodeOperations.cast(thisNode, "USML.structure.IRegion"), callerConceptFqName, "virtual_getContainedOthers_4306907833977812919", new Class[]{SNode.class}, new Object[]{});
  }
}
