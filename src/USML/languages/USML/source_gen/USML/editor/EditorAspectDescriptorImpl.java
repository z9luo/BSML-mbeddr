...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0b = new String[]{"USML.structure.CFunctionBinding", "USML.structure.CreateEventInstance", "USML.structure.DoBlock", "USML.structure.EntryBlock", "USML.structure.EventArgReference", "USML.structure.EventCall", "USML.structure.ExitBlock", "USML.structure.GetEventBinding", "USML.structure.InEventDeclaration", "USML.structure.LocalEventDeclaration", "USML.structure.OutEventDeclaration", "USML.structure.PutEventBinding", "USML.structure.RegionLocalDeclaration", "USML.structure.SMGlobalDeclaration", "USML.structure.SMSafeTerm", "USML.structure.SMStart", "USML.structure.StateLocalDeclaration", "USML.structure.StateMachineBindingsConfigItem", "USML.structure.StateMachineConfigItem", "USML.structure.StateMachineSemanticsConfigItem", "USML.structure.Transition", "USML.structure.TriggerEventReference"};
}
