    ...
    if (ListSequence.fromList(SLinkOperations.getTargets(smTrigger, "actuals", true)).count() != Sequence.fromIterable(BehaviorReflection.invokeVirtual((Class<Iterable<SNode>>) ((Class) Object.class), SLinkOperations.getTarget(smTrigger, "event", false), "virtual_args_2486662774781081797", new Object[]{})).count()) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(smTrigger, "wrong number of arguments; expecting" + BehaviorReflection.invokeVirtual(String.class, SLinkOperations.getTarget(smTrigger, "event", false), "virtual_qualifiedName_5470497459578244269", new Object[]{}), "r:c9ed872e-e0df-47e7-bb05-0b22f068157b(USML.typesystem)", "1054945346927514614", null, errorTarget);
      }
    }
  }
